...
standard: List[List[Optional[Tuple[Instruction, AddressingMode]]]] = [
        ...
        [None, None, None, None, None, None, (i.ROR, m.ZPG_X), None, (i.SEI, m.IMPL), None, None, None, None, None, (i.ROR, m.ABS_X), None], # 7
        ...
        [(i.BEQ, m.REL), None, None, None, None, None, (i.INC, m.ZPG_X), None, (i.SED, m.IMPL), None, None, None, None, None, (i.INC, m.ABS_X), None], # F
    ]
# fmt: on
